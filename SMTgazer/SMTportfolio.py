...
# pyclustering 0.10.1.2 still reads numpy.warnings, removed in NumPy 1.25.
...
if __name__ == '__main__':
    ...
    if work_type == "train":
        ...
        with open(tcenter, 'r', encoding='UTF-8') as f:
            actual_cluster_num = len(json.load(f)['center'])
        outputfile = "output/train_result_" + str(dataset) + "_4_" + str(cluster_num) + "_" + str(seed) + ".json"
        get_portfolio_3(solverlist, td, tc, tflim, tcenter, dataset, outputfile = outputfile, portfolioSize = 4, cluster_num = actual_cluster_num, seed = seed, timelimit = 1200)
